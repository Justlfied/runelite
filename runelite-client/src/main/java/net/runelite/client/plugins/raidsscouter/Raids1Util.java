package net.runelite.client.plugins.raidsscouter;
...
public class Raids1Util
{
    ...
    public static int getroom_type(int zonecode) {
        switch (zonecode & 0x3FF3FE0) { case 6689856: case 6690368: case 6690400: case 6755392: case 6755904: case 6755936:
            case 6820928:
            case 6821440:
            case 6821472:
                return 0;
            case 6689792: case 6689824: case 6755360:
                return 1;
            case 6689888: case 6755424: case 6820960: case 23467104: case 23532640:
            case 23598176:
                return 2;
            case 6690112: case 6755648: case 6821184: case 23467328: case 23532864:
            case 23598400:
                return 3;
            case 6689920: case 6755456: case 6820992:
                return 4;
            case 6689952: case 6755488: case 6821024:
                return 5;
            case 6689984: case 6755520: case 6821056:
                return 6;
            case 23467136: case 23532672: case 23598208:
                return 7;
            case 23467168: case 23532704: case 23598240:
                return 8;
            case 23467200: case 23532736: case 23598272:
                return 9;
            case 40244352: case 40309888: case 40375424:
                return 10;
            case 40244384: case 40309920: case 40375456:
                return 11;
            case 6690016: case 6755552: case 6821088:
                return 12;
            case 6690048: case 6755584: case 6821120:
                return 13;
            case 23467232: case 23532768: case 23598304:
                return 14;
            case 40244448: case 40309984: case 40375520:
                return 15; }
    ...
    public static int getroom_winding(int zonecode) { return (zonecode >> 16 & 0xFF) - 103 & 0x3; }

    public static int getroom_rot(int zonecode) { return zonecode >> 1 & 0x3; }

    public static int getroom_exitside(int zonecode) { return getroom_winding(zonecode) + getroom_rot(zonecode) & 0x3; }
}
